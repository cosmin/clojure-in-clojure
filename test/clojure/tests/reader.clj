(ns clojure.tests.reader
  (:require [clojure.reader :as cr])
  (:use [clojure.test]))
...
(deftest test-records
  (is (= #clojure.tests.reader.Person["test" 18]
         (cr/read-string "#clojure.tests.reader.Person[\"test\" 18]")))
  (is (= #clojure.tests.reader.Person{:age 18}
         (cr/read-string "#clojure.tests.reader.Person{:age 18}"))))
