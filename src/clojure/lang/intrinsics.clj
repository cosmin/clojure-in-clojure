(ns clojure.lang.intrinsics
  (:import [clojure.asm Opcodes]))

(defn oa [& args]
  (into-array Integer/TYPE args))
...
(def ops
  {"public static double clojure.lang.Numbers.add(double,double)" Opcodes/DADD,
   ...
   "public static long clojure.lang.Numbers.shiftLeft(long,long)" (oa Opcodes/L2I Opcodes/LSHL),
   "public static long clojure.lang.Numbers.shiftRight(long,long)" (oa Opcodes/L2I Opcodes/LSHR),
   ...
   "public static double clojure.lang.Numbers.inc(double)" (oa Opcodes/DCONST_1 Opcodes/DADD),
   "public static double clojure.lang.Numbers.dec(double)" (oa Opcodes/DCONST_1 Opcodes/DSUB),
   ...
   "public static int clojure.lang.Numbers.unchecked_int_inc(int)" (oa Opcodes/ICONST_1 Opcodes/IADD),
   "public static int clojure.lang.Numbers.unchecked_int_dec(int)" (oa Opcodes/ICONST_1 Opcodes/ISUB),
   ...
   "public static double clojure.lang.Numbers.unchecked_inc(double)" (oa Opcodes/DCONST_1 Opcodes/DADD),
   "public static long clojure.lang.Numbers.unchecked_inc(long)" (oa Opcodes/LCONST_1 Opcodes/LADD),
   "public static double clojure.lang.Numbers.unchecked_dec(double)" (oa Opcodes/DCONST_1 Opcodes/DSUB),
   "public static long clojure.lang.Numbers.unchecked_dec(long)" (oa Opcodes/LCONST_1 Opcodes/LSUB),
...
(def preds
  {"public static boolean clojure.lang.Numbers.lt(double,double)" (oa Opcodes/DCMPG Opcodes/IFGE),
   "public static boolean clojure.lang.Numbers.lt(long,long)" (oa Opcodes/LCMP Opcodes/IFGE),
   "public static boolean clojure.lang.Numbers.equiv(double,double)" (oa Opcodes/DCMPL Opcodes/IFNE),
   "public static boolean clojure.lang.Numbers.equiv(long,long)" (oa Opcodes/LCMP Opcodes/IFNE),
   "public static boolean clojure.lang.Numbers.lte(double,double)" (oa Opcodes/DCMPG Opcodes/IFGT),
   "public static boolean clojure.lang.Numbers.lte(long,long)" (oa Opcodes/LCMP Opcodes/IFGT),
   "public static boolean clojure.lang.Numbers.gt(long,long)" (oa Opcodes/LCMP Opcodes/IFLE),
   "public static boolean clojure.lang.Numbers.gt(double,double)" (oa Opcodes/DCMPL Opcodes/IFLE),
   "public static boolean clojure.lang.Numbers.gte(long,long)" (oa Opcodes/LCMP Opcodes/IFLT),
   "public static boolean clojure.lang.Numbers.gte(double,double)" (oa Opcodes/DCMPL Opcodes/IFLT),
   "public static boolean clojure.lang.Util.equiv(long,long)" (oa Opcodes/LCMP Opcodes/IFNE),
   "public static boolean clojure.lang.Util.equiv(boolean,boolean)" (oa Opcodes/IF_ICMPNE),
   "public static boolean clojure.lang.Util.equiv(double,double)" (oa Opcodes/DCMPL Opcodes/IFNE),
   "public static boolean clojure.lang.Numbers.isZero(double)" (oa Opcodes/DCONST_0 Opcodes/DCMPL Opcodes/IFNE),
   "public static boolean clojure.lang.Numbers.isZero(long)" (oa Opcodes/LCONST_0 Opcodes/LCMP Opcodes/IFNE),
   "public static boolean clojure.lang.Numbers.isPos(long)" (oa Opcodes/LCONST_0 Opcodes/LCMP Opcodes/IFLE),
   "public static boolean clojure.lang.Numbers.isPos(double)" (oa Opcodes/DCONST_0 Opcodes/DCMPL Opcodes/IFLE),
   "public static boolean clojure.lang.Numbers.isNeg(long)" (oa Opcodes/LCONST_0 Opcodes/LCMP Opcodes/IFGE),
   "public static boolean clojure.lang.Numbers.isNeg(double)" (oa Opcodes/DCONST_0 Opcodes/DCMPG Opcodes/IFGE)
   })